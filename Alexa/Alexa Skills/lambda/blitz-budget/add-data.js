            ...
            if(utils.isEmpty(slotValues.number.heardAs)) {
                ...
                if (slotValues.categories.heardAs && slotValues.categories.heardAs !== '') {
                    ...
                    if(utils.isEmpty(category)) {
                        slotStatus = constants.THE_MESSAGE + slotValues.categories.heardAs + constants.CATEGORY_EMPTY + slotValues.categories.heardAs;
                        shouldEndSession = false;
                    } else {
                        ...
                        if(utils.includesStr(slotStatus, constants.SUCCESSFUL_TITLE)) {
                            ...
                            responseBuilder.withSimpleCard(constants.CARD_SECURITY_TITLE, constants.ADDED_NEW_TRANSACTION_SIMPLE_CARD);   
                        }
                    }
                } else {
            ...
            if (slotValues.category.heardAs && slotValues.category.heardAs !== '') {
                ...
                if(utils.isEmpty(category)) {
                    ...
                    if(utils.isEmpty(budget)) {
                        ...
                        if(utils.includesStr(slotStatus, constants.SUCCESSFUL_TITLE)) {
                            // Send a simple card to Alexa on Success
                            responseBuilder.withSimpleCard(constants.CARD_SECURITY_TITLE, constants.ADDED_NEW_BUDGET_SIMPLE_CARD);   
                        }
                    } else {
                        slotStatus += constants.THE_MESSAGE + slotValues.category.heardAs + constants.BUDGET_CREATED_ERROR;
                    }
                }
            } else {
...
adddata.prototype.addNewGoal_Handler =  {
    ...
    async handle(handlerInput) {
        ...
        if(utils.isEmpty(wallet)) {
            ...
            let goalType = utils.isEmpty(slotValues.goaltype.id) ? slotValues.goaltype.heardAs : slotValues.goaltype.id;
            if(utils.isEmpty(slotValues.goaltype.heardAs) && utils.isEmpty(slotValues.goaltype.id)) {
                ...
                if(utils.includesStr(slotStatus, constants.SUCCESSFUL_TITLE)) {
                    // Send a simple card to Alexa on Success
                    responseBuilder.withSimpleCard(constants.CARD_SECURITY_TITLE, constants.ADDED_NEW_GOAL_SIMPLE_CARD);   
                }
            }
        }
        ...
        if (slotValues.currency.heardAs && slotValues.currency.heardAs !== '') {
            ...
            if(utils.isEmpty(matchedCurrency)) {
               ...
               shouldEndSession = false;
                ...
                if(utils.includesStr(slotStatus, constants.SUCCESSFUL_TITLE)) {
                    // Send a simple card to Alexa on Success
                    responseBuilder.withSimpleCard(constants.CARD_SECURITY_TITLE, constants.ADDED_NEW_WALLET_SIMPLE_CARD);   
                }
            }
        } else {
            slotStatus += constants.ERR_MESSAGE;
            ...
            if(utils.isEmpty(wallet)) {
                ...
                if (slotValues.category.heardAs && slotValues.category.heardAs !== '') {
                    ...
                    if(utils.isEmpty(category)) {
                        ...
                        if(utils.includesStr(slotStatus, constants.SUCCESSFUL_TITLE)) {
                            // Send a simple card to Alexa on Success
                            responseBuilder.withSimpleCard(constants.CARD_SECURITY_TITLE, constants.ADDED_NEW_CATEGORY_SIMPLE_CARD);   
                        }
                    } else {
                        slotStatus += constants.CATEGORY_EXISTS + slotValues.category.heardAs;
                        shouldEndSession = false;
                    }
                } else {
                    slotStatus += constants.ERR_MESSAGE;
