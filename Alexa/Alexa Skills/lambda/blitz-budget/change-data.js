...
changedata.prototype.changeDefaultAccount_Handler =  {
    ...
    async handle(handlerInput) {
        ...
        if (slotValues.account.heardAs && slotValues.account.heardAs !== '') {
            ...
            if(utils.includesStr(slotStatus, constants.SUCCESSFUL_TITLE)) {
                // Send a simple card to Alexa on Success
                responseBuilder.withSimpleCard(constants.CARD_SECURITY_TITLE, constants.CHANGED_DEFAULT_ACCOUNT_SIMPLE_CARD);   
            }
        } else {
            slotStatus = constants.ERR_MESSAGE;
            shouldEndSession = false;
            ...
            if (slotValues.category.heardAs && slotValues.category.heardAs !== '') {
                ...
                if(utils.isEmpty(category)) {
                    ...
                    if(utils.isEmpty(budget)) {
                        ...
                        if(utils.includesStr(slotStatus, constants.SUCCESSFUL_TITLE)) {
                            // Send a simple card to Alexa on Success
                            responseBuilder.withSimpleCard(constants.CARD_SECURITY_TITLE, constants.CHANGED_BUDGET_AMOUNT_SIMPLE_CARD);   
                        }
                    }
                }
            } else {
