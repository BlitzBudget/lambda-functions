...
module.exports = {
    ...
    EMPTY_TAG : ' tag is not present in any of the transactions. Please try again!',
    BUDGET_NOT_CREATED_TWO : ' by saying <break time="0.20s"/> "Add a new budget for "',
    BUDGET_NOT_CREATED : ' budget has not been created. Consider creating a budget for ',
    EMPTY_CATEGORY : 'I didn\'t get the category entered for the transaction. Please try again!',
    HELP_MESSAGE : 'You can say: \'alexa, hello\', \'alexa, tell me my info\' or \'alexa, who am I\'.',
    INCOME_CATEGORY_ERROR : 'Sorry! it is not possible to create a budget for an income category. Please try again!',
    GREETING_MESSAGE : '. <amazon:emotion name="excited" intensity="low"> What can I do for you today?  </amazon:emotion>',
    BUDGET_EMPTY_ERROR : ' budget is not created. Consider creating a new budget by saying <break time="0.20s"/> "Create a new budget for "',
    CATEGORY_EMPTY : ' category has not been created. Consider creating a new category by saying <break time="0.20s"/> "Create a new category for "',
    NEED_TO_LINK_MESSAGE : 'Before we can continue, you will need to link your account to the skill using the card that I have sent to the Alexa app.',
    ERR_MESSAGE : '<amazon:emotion name="disappointed" intensity="medium"> Sorry, I can\'t understand that request. Please try again! </amazon:emotion>',
    WALLET_IS_NOT_PRESENT : 'The wallet that you mentioned is not present. Consider adding a wallet by saying <break time="0.20s"/> "Add a new wallet for" ',
    EMPTY_AMOUNT : '<amazon:emotion name="disappointed" intensity="medium"> I didn\'t get the amount entered for the transaction. Please try again! </amazon:emotion>',
    ...
    CHANGED_DEFAULT_WALLET_SIMPLE_CARD : "The default wallet for Alexa has been changed.",
    CHANGED_DEFAULT_ACCOUNT_SIMPLE_CARD : "The default account for Alexa has been changed.",
    ADDED_NEW_CATEGORY_SIMPLE_CARD : "A new category has been added through Alexa.",
    ADDED_NEW_WALLET_SIMPLE_CARD : "A new wallet has been added through Alexa.",
    CHANGED_BUDGET_AMOUNT_SIMPLE_CARD : "A budget's amount has been changed through Alexa.",
