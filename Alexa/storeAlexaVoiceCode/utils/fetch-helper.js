...
*/
async function handleGetNewVoiceCode(userId, alexaId, voiceCodePresent, docClient) {
    await fetchVoiceCode.getNewVoiceCode(userId, docClient).then(function (result) {
        if (result.Count > 0) {
