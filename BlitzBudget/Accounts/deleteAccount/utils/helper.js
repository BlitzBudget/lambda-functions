...
async function fetchAccountsTransactionsAndRecurringTrans(events, walletId, result, DB) {
...
helper.prototype.fetchAccountsTransactionsAndRecurringTrans = fetchAccountsTransactionsAndRecurringTrans(events, walletId, result);
helper.prototype.deleteAccountsAndItsData = deleteAccountsAndItsData(events, deleteRequests);
