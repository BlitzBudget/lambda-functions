...
exports.handler = async (event) => {
    ...
    walletId = await fetchHelper.fetchWalletsIfEmpty(walletId, userId, budgetData, docClient);

    await fetchHelper.fetchAllInformationForBudget(events, walletId, startsWithDate, endsWithDate, fullMonth, budgetData, docClient);
