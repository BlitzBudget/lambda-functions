 ...
 */
function constructTransactionsWithDateMeantForAndCategory(datesMap, categoryMap, event, addItemArray) {
    let { nextScheduledDate, today, dateMeantFor, category, walletId, recurrence, amount, description, account, tags } = extractVariablesFromRequest();
    ...
    function extractVariablesFromRequest() {
        ...
        let today = new Date();
        return { nextScheduledDate, today, dateMeantFor, category, walletId, recurrence, amount, description, account, tags };
    }
}
