...
exports.handler = async function (event) {
  ...
  headers['content-security-policy'] = [{
    ...
    value: "default-src https://blog.blitzbudget.com/; img-src 'unsafe-inline' 'self' data:; script-src https://cdn.jsdelivr.net 'unsafe-inline' 'self'; style-src https://use.fontawesome.com/ https://cdnjs.cloudflare.com/ https://blog.blitzbudget.com/ https://fonts.googleapis.com 'self' 'unsafe-inline'; object-src 'none'; connect-src 'self'; font-src https://use.fontawesome.com 'self' https://fonts.gstatic.com; style-src-elem https://use.fontawesome.com/ https://cdnjs.cloudflare.com/ https://fonts.googleapis.com/ 'self' 'unsafe-inline';",
  }];
